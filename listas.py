...
apeMayorEdad = edades.index(max(edades))
...
print("Se a añadido a la lista el nombre de la instrcutora: ", instru)
...
print("Los elementos del 10 al 20 en la lista son: ", aprendices[9:20])